...
import com.heima.chat.fragment.FillInfoFra;
import com.heima.chat.fragment.LogoFra;
import com.heima.chat.fragment.SignInFra;
import com.heima.chat.fragment.SignUpFra;
...
public class LoginActivity extends BaseActivity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (enterFlag == ENTER_FIRST) {
			...
			// 第一次登录		
			currentFra = new LogoFra();			Bundle args = new Bundle();
			args.putInt(LogoFra.ARG_KEY, LogoFra.ARG_TYPE_FIRST);
			currentFra.setArguments(args);  	currentTag = TAG_LOGO;
